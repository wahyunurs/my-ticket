...
import com.example.myticket.Connection.DashboardQuery;
...
public class DashboardController implements Initializable {
    ...
    @FXML
    private Label dataPerjalananCountLabel;
    @FXML
    private Label dataTiketCountLabel;
    @FXML
    private Label pemesananTiketCountLabel;
    ...
    public void initialize (URL url, ResourceBundle resourceBundle) {
        ...
        DashboardModel dashboardModel = dashboardQuery.getDashboardData();
        dataPerjalananCountLabel.setText(String.valueOf(dashboardModel.getDataPerjalananCount()));
        dataTiketCountLabel.setText(String.valueOf(dashboardModel.getDataTiketCount()));
        pemesananTiketCountLabel.setText(String.valueOf(dashboardModel.getPemesananTiketCount()));
    }
